#ifndef RE_COMM_VENC_H
#define RE_COMM_VENC_H

#include "re_type.h"

#include "re_comm_rc.h"
...
typedef struct xmJPEG_ENC_ATTR_S {
  int lumWidthSrc;  // align by 16
  int lumHeightSrc; // align by 2
  int horOffsetSrc; // align by 2
  int verOffsetSrc; // align by 2
  int dstWidth;     //>=96  align by 4
  int dstHeight;    //>=32  aling by 2
} JPEG_ENC_ATTR_S;
...
typedef struct xmVENC_PARAM_H264_INTRA_PRED_S {
  ...
  XM_U32 constrained_intra_pred_flag; /*default: HI_FALSE, see the H.264
                                         protocol*/
...
typedef struct xmVENC_PARAM_VUI_VIDEO_SIGNAL_S {
  XM_U8 video_signal_type_present_flag;  /* default value: 0. If 1, video
                                            singnal info will be encoded into
                                            vui. {0,1} */
...
typedef struct xmVENC_PARAM_MPEG4_S {
  ...
  XM_U32 u32SplitMode;  /*0:bit number, 1:mb line number, >=2:no meaning*/
  XM_U32
  u32PacketSize; /*when the splitmode is 0, this value presents the
                    bitsnum of one packet average, when the splitmode is
                    1, this value presents the mb num of one packet*/
...
typedef struct xmVENC_ROI_CFG_S {
  ...
  XM_BOOL bAbsQp;  /* QP mode of an ROI.HI_FALSE: relative QP.HI_TURE: absolute
                      QP.*/
