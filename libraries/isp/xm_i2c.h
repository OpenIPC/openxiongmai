...
int XM_I2C_Write(unsigned char dev_addr, unsigned int reg_addr,
                 unsigned int addr_byte_num, unsigned int data,
                 unsigned int data_byte_num);
int XM_I2C_Read(unsigned char dev_addr, unsigned int reg_addr,
