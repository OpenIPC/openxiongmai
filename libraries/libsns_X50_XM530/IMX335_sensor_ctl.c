...
static const XM_U16 gau16SnsInit_IMX335[][2] = {
    ...
    {
        0x341D,
        0x00}, // ADBIT1 10Bit:0x01FF  12Bit:0x0047{0x3648,  0,  8) = 0x01  //
    {0x364A, 0x04}, //
    {0x364C, 0x04}, //
    {0x3678, 0x01}, //
    {0x367C, 0x31}, //
...
void sensor_init_IMX335(void) {
  ...
  sensor_write_register(
      (XM_U32)gau16SnsInit_IMX335[0][0],
      (XM_U32)gau16SnsInit_IMX335[0][1]); // reset all registers
  for (u16i = 1; u16i < u16Num; u16i++) {
    sensor_write_register((XM_U32)gau16SnsInit_IMX335[u16i][0],
                          (XM_U32)gau16SnsInit_IMX335[u16i][1]);
  }
  // release standby
