...
static const ISP_CMOS_AGC_TABLE_S g_stIspAgcTable = {
    ...
    {0x40, 0x3E, 0x3E, 0x3C, 0x3C, 0x28, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08,
     0x08, 0x08, 0x08, 0x08},
    /* snr_thresh 2DNr		*/
    {0x01, 0x03, 0x06, 0x0C, 0x1C, 0x28, 0x40, 0x48, 0x48, 0x48, 0x48, 0x48,
     0x48, 0x48, 0x48, 0x48},
    /* snr_thresh 3DNr	 Tf	*/
    {0x11, 0x12, 0x13, 0x15, 0x18, 0x1A, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C,
     0x1C, 0x1C, 0x1C, 0x1C},
    /* snr_thresh 3DNr	 Sf	*/
    ...
    {0xB8, 0xC0, 0xD0, 0xD4, 0xD8, 0xDC, 0xE0, 0xE0, 0xF0, 0xF0, 0xF0, 0xF0,
     0xF0, 0xF0, 0xF0, 0xF0},
    /* saturation_strength */
    {0x98, 0x98, 0x94, 0x80, 0x58, 0x50, 0x38, 0x30, 0x30, 0x30, 0x30, 0x30,
     0x30, 0x30, 0x30, 0x30},
    /* Blc	*/
    //{0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111,0x111},
    {0x108, 0x108, 0x108, 0x100, 0x0F0, 0x0E8, 0x0E8, 0x0E8, 0x0E8, 0x0E8,
     0x0E8, 0x0E8, 0x0E8, 0x0E8, 0x0E8, 0x0E8},
    /*Y_Tran gamma*/
...
static const XM_U8 gau8AgcTabXvi_apollo[5][8] = {
    ...
    {0x01, 0x03, 0x03, 0x05, 0x08, 0x0E, 0x14,
...
static const XM_U8 gau8AgcTabCvbs_apollo[5][8] = {
    ...
    {0x01, 0x01, 0x03, 0x05, 0x08, 0x0E, 0x10,
     0x20},                                          /* snr_thresh 2DNr		*/
...
static ISP_COLORMATRIX_AUTO_S g_stAwbCcm = {
    5000,
    {
        0x0000, 429, -186, 13, 0x0000, -50, 444, -138, 0x0000, -40, -183,
        479 // -8,   -183,  447
    },
    4000,
    {0x0000, 466, -249, 39, 0x0000, -105, 407, -46, 0x0000, -10, -188, 454},
    2800,
    {0x0000, 332, -65, -11, 0x0000, -116, 427, -55, 0x0000, -56, -394, 706}};
 ...
 ****************************************************************************/
XM_S32
cmos_init_sensor_exp_function_apollo(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc) {
