...
static const ISP_CMOS_AGC_TABLE_S g_stIspAgcTable = {
    ...
    {0xA0, 0xA0, 0x9A, 0x90, 0x88, 0x78, 0x50, 0x50, 0x50, 0x10, 0x10, 0x10,
     0x10, 0x10, 0x10, 0x10},
    /* Blc	*/
    {0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40,
     0x40, 0x40, 0x40, 0x40},
    /*Y_Tran gamma*/
...
static const ISP_COLORMATRIX_AUTO_S g_stAwbCcm = {
    5000, // 0.28
    {0x000, 359, -110, 7, 0x000, -51, 405, -98, 0x000, 28, -118, 346},
    4000, // 0.25
    {0x000, 356, -122, 22, 0x000, -61, 383, -66, 0x000, 32, -136, 360},
    2800, // 0.2
    {0x000, 288, -29, -3, 0x000, -75, 387, -56, 0x000, 3, -228, 481}};
