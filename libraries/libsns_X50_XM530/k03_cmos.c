...
static const ISP_CMOS_AGC_TABLE_S g_stIspAgcTable = {
    ...
    /* 100, 200, 400, 800, 1600, 3200, 6400, 12800; 100, 200, 400, 800, 1600,
       3200, 6400, 12800 */
    /* sharpen_D	H	*/
    {0x14, 0x14, 0x14, 0x14, 0x12, 0x12, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E, 0x0E,
     0x0E, 0x0E, 0x0E, 0x0E},
    /* sharpen_Ud M	*/
    {0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10,
     0x10, 0x10, 0x10, 0x10},
    /* sharpen_Kd  */
    {0x40, 0x3E, 0x3E, 0x3C, 0x3C, 0x28, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08,
     0x08, 0x08, 0x08, 0x08},
    /* snr_thresh 2DNr		*/
    {0x00, 0x02, 0x06, 0x0C, 0x1C, 0x28, 0x40, 0x48, 0x48, 0x48, 0x48, 0x48,
     0x48, 0x48, 0x48, 0x48},
    /* snr_thresh 3DNr	 Tf	*/
    {0x0F, 0x11, 0x13, 0x15, 0x18, 0x1A, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C,
     0x1C, 0x1C, 0x1C, 0x1C},
    /* snr_thresh 3DNr	 Sf	*/
    {0x10, 0x10, 0x18, 0x20, 0x28, 0x2A, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
     0x30, 0x30, 0x30, 0x30},
    /* DyDpc_thresh 		*/
    {0xB8, 0xC0, 0xD0, 0xD4, 0xD8, 0xDC, 0xE0, 0xE0, 0xF0, 0xF0, 0xF0, 0xF0,
     0xF0, 0xF0, 0xF0, 0xF0},
    /* saturation_strength */
    {0xA0, 0x9A, 0x94, 0x8C, 0x7C, 0x64, 0x50, 0x50, 0x50, 0x10, 0x10, 0x10,
     0x10, 0x10, 0x10, 0x10},
    /* Blc	*/
    {0x42, 0x42, 0x42, 0x40, 0x3e, 0x32, 0x30, 0x30, 0x20, 0x20, 0x20, 0x20,
     0x20, 0x20, 0x20, 0x20},
    /*Y_Tran gamma*/
    {0x32, 0x32, 0x32, 0x30, 0x2e, 0x2a, 0x2a, 0x26, 0x26, 0x26, 0x26, 0x26,
     0x26, 0x26, 0x26, 0x26}};
static const XM_U8 gau8AgcTabXvi_K03[5][8] = {
    ...
    {0x00, 0x01, 0x03, 0x05, 0x08, 0x0E, 0x14,
     0x20},                                          /* snr_thresh 2DNr		*/
...
static const XM_U8 gau8AgcTabCvbs_K03[5][8] = {
    ...
    {0x00, 0x01, 0x03, 0x05, 0x08, 0x0E, 0x10,
     0x20},                                          /* snr_thresh 2DNr		*/
...
/* 4M */
static const XM_U8 gsau8Saturation[8] = {0xC4, 0xC0, 0xB6, 0xAC,
                                         0x94, 0x74, 0x48, 0x10};
  ...
  default: // AHD/CVI/TVI
    ...
    for (u8i = 0; u8i < 8; u8i++) {
      stSharpenAttr.stAuto.au8SharpenD[u8i] =
          g_stIspAgcTable.au8SharpenAltD[u8i];
      stSharpenAttr.stAuto.au8SharpenUd[u8i] =
          g_stIspAgcTable.au8SharpenAltUd[u8i];
      stSharpenAttr.stAuto.au8SharpenKd[u8i] =
          g_stIspAgcTable.au8SharpenKd[u8i];
...
static const XM_U8 gau8FpsSet[][6] = {
    ...
    {0x12, 0x40, 0x42, 0x42, 0x40, 0x40}, {0x0D, 0x53, 0x53, 0x53, 0x53, 0xA3},
    {0x0E, 0x11, 0x12, 0x12, 0x10, 0x11}, {0x10, 0x42, 0x50, 0x50, 0x1E, 0x1E},
    {0x60, 0x12, 0x10, 0x10, 0x12, 0x12}, {0x24, 0x80, 0x80, 0x80, 0x82, 0x82},
    {0x25, 0x98, 0xB4, 0xCA, 0xA8, 0xA8}, {0x26, 0x72, 0x22, 0x22, 0x52, 0x52},
    {0x27, 0x73, 0x80, 0x01, 0x51, 0xC7}, {0x28, 0x1D, 0x13, 0x13, 0x29, 0x23},
    {0x29, 0x02, 0x02, 0x02, 0x02, 0x01}, {0x2A, 0x5E, 0x5E, 0xDE, 0x31, 0xB2},
    {0x2B, 0x22, 0x22, 0x21, 0x22, 0x21}, {0x2C, 0x0E, 0x01, 0x01, 0x04, 0x11},
    {0x2D, 0x01, 0x46, 0x3F, 0x3B, 0x38}, {0x2E, 0xEE, 0xAF, 0xBF, 0xB0, 0xAE},
    {0x30, 0xA4, 0xA4, 0xBB, 0xA4, 0x87}, {0x32, 0x0C, 0x0C, 0x0C, 0x0C, 0x06},
    {0x33, 0x0C, 0x0C, 0x0C, 0x0C, 0x09}, {0x34, 0x13, 0x13, 0x13, 0x13, 0x1C},
    {0x3D, 0x00, 0x00, 0x00, 0x00, 0x08}, {0x3E, 0xB8, 0xB8, 0xB8, 0xB8, 0xA0},
    {0x5D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2F}, {0x70, 0x69, 0x69, 0x69, 0x69, 0x25},
    {0x71, 0x4E, 0x4E, 0x4E, 0x4E, 0x26}, {0x73, 0xA4, 0xA4, 0xA4, 0xA4, 0x91},
    {0x74, 0x86, 0x46, 0x46, 0x86, 0x86}, {0x75, 0x02, 0x02, 0x02, 0x02, 0x04},
    {0x77, 0x0A, 0x05, 0x05, 0x0A, 0x0A}, {0x78, 0x94, 0x94, 0x94, 0x94, 0x88},
    {0x7A, 0x32, 0x32, 0x32, 0x32, 0x43}, {0x7D, 0x81, 0x81, 0x81, 0x81, 0x42},
    {0x7E, 0x0C, 0x0C, 0x0C, 0x0C, 0x08}, {0x87, 0xB7, 0xB7, 0xA6, 0xB7, 0xB7},
    {0x88, 0x0F, 0x0F, 0x0E, 0x0F, 0x0F}, {0x92, 0x64, 0x64, 0x64, 0x64, 0x7F}};
...
static XM_VOID cmos_fps_set(XM_U8 u8Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft) {
  ...
  for (u8i = 0; u8i < u8Num; u8i++) {
    sensor_write_register((XM_U32)gau8FpsSet[u8i][0],
                          (XM_U32)gau8FpsSet[u8i][u8Idx]);
  }
  ...
  u8Tmp = (u8Tmp & 0x30) +
          sensor_read_register(0x12); //防止Mirror和Flip标志位被清楚
...
static ISP_COLORMATRIX_AUTO_S g_stAwbCcm = {
    5000, // 0.14392
    {0x0000, 294, -16, -22, 0x0000, -89, 373, -28, 0x0000, 8, -59, 307},
    4000, // 0.14392
    {0x0000, 289, -9, -24, 0x0000, -64, 370, -50, 0x0000, -13, -49, 318},
    2800, // 0.10486
    {0x0000, 260, 51, -55, 0x0000, -92, 421, -73, 0x0000, -50, -30, 336}};
/*
static ISP_COLORMATRIX_AUTO_S g_stAwbCcm =
{
        5000,//0.14392
 ...
 ****************************************************************************/
XM_S32
cmos_init_sensor_exp_function_k03(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc) {
  //    XM_MPI_ISP_Memset((char *)pstSensorExpFunc, 0,
