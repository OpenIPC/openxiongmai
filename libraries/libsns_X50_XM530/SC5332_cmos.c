...
static const ISP_CMOS_AGC_TABLE_S g_stIspAgcTable = {
    ...
    /* 100, 200, 400, 800, 1600, 3200, 6400, 12800; 100, 200, 400, 800, 1600,
       3200, 6400, 12800 */
    /* sharpen_D	H	*/
    {0x30, 0x2E, 0x28, 0x20, 0x1C, 0x10, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4},
    /* sharpen_Ud M	*/
    {0x2E, 0x2A, 0x28, 0x24, 0x22, 0x14, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8},
    /* sharpen_Kd  */
    {0x3E, 0x3C, 0x38, 0x30, 0x28, 0x10, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4},
    /* snr_thresh 2DNr		*/
    {0, 1, 6, 8, 0x18, 0x30, 0x40, 0x40, 0x48, 0x48, 0x48, 0x48, 0x48, 0x48,
     0x48, 0x48},
    /* snr_thresh 3DNr	 Tf	*/
    {2, 4, 6, 8, 0x10, 0x14, 0x16, 0x18, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C,
     0x1C, 0x1C},
    /* snr_thresh 3DNr	 Sf	*/
    {1, 2, 8, 0xC, 0x12, 0x28, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40,
     0x40, 0x40},
    /* DyDpc_thresh 		*/
    {0xB8, 0xC0, 0xD0, 0xD4, 0xD8, 0xDC, 0xE0, 0xE0, 0xF0, 0xF0, 0xF0, 0xF0,
     0xF0, 0xF0, 0xF0, 0xF0},
    /* saturation_strength */
    {0xA0, 0xA0, 0x9A, 0x90, 0x88, 0x78, 0x50, 0x50, 0x50, 0x10, 0x10, 0x10,
     0x10, 0x10, 0x10, 0x10},
    /* Blc	*/
    {0x110, 0x110, 0x110, 0x110, 0x110, 0x110, 0x110, 0x110, 0x110, 0x110,
     0x110, 0x110, 0x110, 0x110, 0x110, 0x110},
    /*Y_Tran gamma*/
    {0x34, 0x34, 0x34, 0x35, 0x35, 0x35, 0x30, 0x30, 0x26, 0x26, 0x26, 0x26,
     0x26, 0x26, 0x26, 0x26}};
...
static XM_S32 cmos_set_mirror_flip(XM_U8 u8Mirror, XM_U8 u8Flip) {
  ...
  u32Tmp = sensor_read_register(0x3221);
  if (u8Mirror) {
    v5 = 8;
    v6 = u32Tmp | 6;
  } else {
    v6 = u32Tmp & 0xFFFFFFF9;
    v5 = 0;
  }
  if (u8Flip)
    v7 = 4;
  ...
  if (u8Flip)
    ...
    u32Tmp = v6 & 0xFFFFFF9F;
  sensor_write_register(0x3221, u32Tmp);
  VI_WinSet(1, u8Mirror, u8Flip, v5, v7);
...
// TODO
XM_S32 cmos_init_ae_exp_function_sc5332(AE_SENSOR_EXP_FUNC_S *pstExpFuncs) {
...
// TODO
XM_S32 cmos_init_awb_exp_function_sc5332(AWB_SENSOR_EXP_FUNC_S *pstExpFuncs) {
