...
static const ISP_CMOS_AGC_TABLE_S g_stIspAgcTable = {
    ...
    /* 100, 200, 400, 800, 1600, 3200, 6400, 12800; 100, 200, 400, 800, 1600,
       3200, 6400, 12800 */
    /* sharpen_D	H	*/
    {0x30, 0x2E, 0x28, 0x20, 0x1c, 0x10, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04,
     0x04, 0x04, 0x04, 0x04},
    /* sharpen_Ud M	*/
    {0x2E, 0x2A, 0x28, 0x24, 0x22, 0x14, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08,
     0x08, 0x08, 0x08, 0x08},
    /* sharpen_Kd  */
    {0x3E, 0x3C, 0x38, 0x30, 0x28, 0x10, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04,
     0x04, 0x04, 0x04, 0x04},
    /* snr_thresh 2DNr		*/
    {0x00, 0x01, 0x06, 0x08, 0x18, 0x30, 0x40, 0x40, 0x48, 0x48, 0x48, 0x48,
     0x48, 0x48, 0x48, 0x48},
    /* snr_thresh 3DNr	 Tf	*/
    {0x02, 0x04, 0x06, 0x08, 0x10, 0x14, 0x16, 0x18, 0x1C, 0x1C, 0x1C, 0x1C,
     0x1C, 0x1C, 0x1C, 0x1C},
    /* snr_thresh 3DNr	 Sf	*/
    {0x01, 0x02, 0x08, 0x0c, 0x12, 0x28, 0x40, 0x40, 0x40, 0x40, 0x40, 0x40,
     0x40, 0x40, 0x40, 0x40},
    /* DyDpc_thresh 		*/
    {0xB8, 0xC0, 0xD0, 0xD4, 0xD8, 0xDC, 0xE0, 0xE0, 0xF0, 0xF0, 0xF0, 0xF0,
     0xF0, 0xF0, 0xF0, 0xF0},
    /* saturation_strength */
    {0xb2, 0xb0, 0xa8, 0x98, 0x88, 0x78, 0x50, 0x50, 0x50, 0x10, 0x10, 0x10,
     0x10, 0x10, 0x10, 0x10},
    /* Blc	*/
    {0x53, 0x53, 0x53, 0x53, 0x53, 0x53, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44,
     0x44, 0x44, 0x44, 0x44},
    /*Y_Tran gamma*/
    {0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x2d, 0x2d, 0x2d, 0x2d, 0x2d, 0x2d,
     0x2d, 0x2d, 0x2d, 0x2d}};
...
const static XM_U16 gau16LogicAddr[4] = {0x3301, 0x3633, 0x3630, 0x3622};
  ...
  if (((su8Idx & 0x0F) != u8Idx) || ((su8Idx >> 4) & 0x0F) != u8Idx2) {
    ...
    for (u8i = 0; u8i < 4; u8i++) {
      sensor_write_register((XM_U32)gau16LogicAddr[u8i],
                            (XM_U32)gau8Logic_sc5239[u8Idx][u8Idx2][u8i]);
    }
...
static XM_VOID cmos_fps_set(XM_U8 u8Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft) {
  ...
  for (u8i = 0; u8i < u8Num; u8i++) {
    sensor_write_register((XM_U32)gau16FpsSet[u8i][0],
                          (XM_U32)gau16FpsSet[u8i][u8Idx]);
  }
...
static const ISP_COLORMATRIX_AUTO_S g_stAwbCcm = {
    5000,
    {
        0x000, 356, -135, 35, 0x000, -59, 327, -12, 0x000, 5, -145,
        396 // 0x000, -35, -130, 421
    },
    4000,
    {0x000, 327, -130, 59, 0x000, -70, 281, 45, 0x000, -39, -233, 528},
    2800,
    {0x000, 287, -86, 55, 0x000, -87, 269, 74, 0x000, -115, -369, 740}};
...
cmos_init_sensor_exp_function_SC5239(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc) {
  ...
  pstSensorExpFunc->pfn_cmos_get_isp_default =
      cmos_get_isp_default; // cmos_get_isp_default;
  pstSensorExpFunc->pfn_cmos_set_pixel_detect = cmos_set_pixel_detect;
  pstSensorExpFunc->pfn_cmos_get_sensor_max_resolution =
      cmos_get_sensor_max_resolution; // cmos_get_sensor_max_resolution;
