...
const AE_SENSOR_DEFAULT_V2_S gstAeSnsDef_h62 = {1,
                                                HD720P_LINES -
                                                    4, // minInt   	maxInt
                                                1024,
                                                31744, // minAgain maxAgain
                                                32,
...
const ISP_COLORMATRIX_AUTO_S g_stAwbCcm_h62 = {
    5000, {0x0000, 241, 28, -13, 0x0000, -38, 349, -55, 0x0000, 2, -2, 256},
    4000, {0x0000, 242, 7, 7, 0x0000, -95, 354, -3, 0x0000, -21, -44, 321},
    2800, {0x0000, 197, 98, -39, 0x0000, -90, 360, -14, 0x0000, -62, -78, 396}};
