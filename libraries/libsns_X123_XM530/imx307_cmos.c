...
static const XM_U16 gau16ShutCal[35][4] = {
    ...
    {1623, 2, 1024, 0},  {1663, 2, 1059, 1},  {1706, 2, 1097, 2},
    {1773, 2, 1135, 3},  {1822, 2, 1175, 4},  {1861, 2, 1217, 5},
    {1925, 2, 1259, 6},  {1985, 2, 1304, 7},  {2042, 2, 1349, 8},
    {2089, 2, 1397, 9},  {2169, 2, 1446, 10}, {2246, 2, 1497, 11},
    {2302, 2, 1549, 12}, {2351, 2, 1604, 13}, {2407, 2, 1660, 14},
    {2483, 2, 1719, 15}, {2578, 2, 1779, 16}, {2671, 2, 1842, 17},
    {2717, 2, 1906, 18}, {2784, 2, 1973, 19}, {2929, 2, 2043, 20},
    {2945, 3, 1024, 0},  {3044, 3, 1059, 1},  {3100, 3, 1097, 2},
    {3130, 3, 1135, 3},  {3208, 3, 1175, 4},  {3398, 3, 1217, 5},
    {3501, 3, 1259, 6},  {3498, 3, 1304, 7},  {3655, 3, 1349, 8},
    {3796, 3, 1397, 9},  {3908, 3, 1446, 10}, {3976, 3, 1497, 11},
    {4056, 3, 1549, 12}, {4096, 4, 1024, 0},
};
static XM_U8 su8Idx = 0xFF;
STATIC XM_VOID cmos_shut_calc_table(XM_S32 s32IntTime,
                                    AE_SENSOR_SHUTINFO_S *pstAeSnsShutInfo) {
  int i, s32Idx = 0;
  if (s32IntTime < 4) {
...
static XM_S32 cmos_get_sns_regs_info(ISP_SNS_REGS_INFO_S *pstSnsRegsInfo) {
  ...
  XM_MPI_ISP_Memncpy((XM_U8 *)pstSnsRegsInfo, (XM_U8 *)&g_stSnsRegsInfo,
...
const ISP_COLORMATRIX_AUTO_S g_stAwbCcm_imx307 = {5082, // 0.16
                                                  {
                                                      0x0000,
                                                      294,
                                                      -56,
...
XM_U32 sensor_getlist_imx307(XM_U16 *pu16Num) {
  DEBUG(
      "------------- IMX307 2M 30fps  init ok! (@201812111)----------------\n");
