...
static const ISP_CMOS_AGC_TABLE_S g_stIspAgcTable = {
    ...
    /* Blc	*/
    {0x109, 0x109, 0x109, 0x109, 0x109, 0x109, 0x109, 0x109, 0x109, 0x109,
     0x109, 0x109, 0x109, 0x109, 0x109, 0x109},
...
static const ISP_COLORMATRIX_AUTO_S g_stAwbCcm = {
    5000, // 0.16
    {0x000, 356, -148, 48, 0x000, -75, 373, -42, 0x000, 8, -170, 418},
    4000, // 0.16
    {0x000, 358, -167, 65, 0x000, -104, 376, -16, 0x000, -17, -222, 495},
    2800, // 0.16
    {0x000, 290, -70, 36, 0x000, -174, 440, -10, 0x000, -170, -422, 848}};
...
XM_S32
cmos_init_sensor_exp_function_sc2235E(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc) {
...
static const XM_U16 gau16SnsInit_sc2235E[][2] = {
    {0x0103, 0x01}, {0x0100, 0x00}, {0x3001, 0x00}, {0x3002, 0x80},
    {0x3018, 0x33}, {0x301a, 0xf0}, {0x301c, 0x78}, {0x3037, 0x20},
    {0x3038, 0x6e}, {0x3039, 0x52}, {0x303b, 0x14}, {0x303d, 0x10},
    {0x303f, 0x01}, {0x3208, 0x07}, {0x3209, 0x88}, {0x320a, 0x04},
    {0x320b, 0x40}, {0x3221, 0x80}, {0x3301, 0x08}, {0x3303, 0x38},
    {0x3306, 0x50}, {0x3309, 0x70}, {0x330a, 0x00}, {0x3000, 0x00},
    {0x330b, 0xd0}, {0x330d, 0x36}, {0x330e, 0x18}, {0x330f, 0x01},
    {0x3310, 0x23}, {0x3314, 0x14}, {0x331e, 0x31}, {0x331f, 0x69},
    {0x3338, 0x37}, {0x3339, 0x37}, {0x333a, 0x33}, {0x335d, 0x20},
    {0x3364, 0x1d}, {0x3367, 0x08}, {0x33ae, 0x32}, {0x33b3, 0x32},
    {0x33b4, 0x32}, {0x33b6, 0x0f}, {0x33b7, 0x3e}, {0x33b8, 0x08},
    {0x33b9, 0x80}, {0x33ba, 0xc0}, {0x360f, 0x05}, {0x3614, 0x80},
    {0x3622, 0xf6}, {0x3630, 0x40}, {0x3631, 0x88}, {0x3632, 0x88},
    {0x3633, 0x24}, {0x3635, 0x1c}, {0x3637, 0x2c}, {0x3638, 0x24},
    {0x363a, 0x80}, {0x363b, 0x16}, {0x3641, 0x00}, {0x366e, 0x04},
    {0x3670, 0x48}, {0x3671, 0xf6}, {0x3672, 0x16}, {0x3673, 0x16},
    {0x367a, 0x38}, {0x367b, 0x38}, {0x3690, 0x24}, {0x3691, 0x44},
    {0x3692, 0x44}, {0x3699, 0x80}, {0x369a, 0x80}, {0x369b, 0x9f},
    {0x369c, 0x38}, {0x369d, 0x38}, {0x36a2, 0x00}, {0x36a3, 0x3f},
    {0x391e, 0x00}, {0x3933, 0x0a}, {0x3934, 0x10}, {0x3940, 0x60},
    {0x3942, 0x02}, {0x3943, 0x18}, {0x3e00, 0x00}, {0x3e01, 0x8c},
    {0x3e02, 0x20}, {0x3e03, 0x0b}, {0x3e06, 0x00}, {0x3e07, 0x80},
    {0x3e08, 0x03}, {0x3e09, 0x20}, {0x3f00, 0x0f}, {0x3f04, 0x04},
    {0x3f05, 0x28}, {0x4603, 0x00}, {0x5780, 0x7f}, {0x5781, 0x04},
    {0x5782, 0x04}, {0x5783, 0x02}, {0x5784, 0x01}, {0x57a0, 0x00},
    {0x57a1, 0x71}, {0x57a2, 0x01}, {0x57a3, 0xf1}, {0x57a4, 0x60},
    {0x0100, 0x01}};
